/* empty css                      */(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function n(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function r(s){if(s.ep)return;s.ep=!0;const i=n(s);fetch(s.href,i)}})();const E="https://tasty-treats-backend.p.goit.global/api";async function G(){return await(await fetch(`${E}/categories`)).json()}async function _({category:e="",page:t=1,limit:n=6,time:r="",area:s="",ingredient:i=""}={}){const o=new URL(`${E}/recipes`);return e&&o.searchParams.append("category",e),t&&o.searchParams.append("page",t),n&&o.searchParams.append("limit",n),r&&o.searchParams.append("time",r),s&&o.searchParams.append("area",s),i&&o.searchParams.append("ingredient",i),await(await fetch(o)).json()}async function K(){return await(await fetch(`${E}/recipes/popular`)).json()}async function X(){return await(await fetch(`${E}/ingredients`)).json()}async function Z(){return await(await fetch(`${E}/areas`)).json()}const w=document.querySelector("#recipes-container"),H=document.querySelector("#pagination"),q=document.querySelector("#category-list"),y=document.querySelector(".categories-box");let u=1,U=1,m=null,A=R();function R(){const e=window.innerWidth;return e<768?6:e<1280?8:9}async function P(){try{const t=(await G()).map(r=>`
        <li>
          <button 
        ...
        </li>`).join("");q.innerHTML=t;const n=q.querySelectorAll(".category-btn");n.forEach(r=>{r.addEventListener("click",()=>{const s=r.dataset.category;s!==m&&(m=s,u=1,n.forEach(i=>i.classList.remove("active")),y.classList.remove("active"),r.classList.add("active"),M(u))})})}catch(e){console.error("Failed to load categories:",e)}}y&&y.addEventListener("click",()=>{m!==null&&(m=null,u=1,q.querySelectorAll(".category-btn").forEach(t=>t.classList.remove("active")),y.classList.add("active"),M(u))});async function M(e=1){try{A=R();const t=await _({page:e,limit:A,category:m||void 0}),n=t.results;if(U=t.totalPages||Math.ceil(t.totalResults/A),!n||n.length===0){w.innerHTML="<p>No recipes found to display.</p>",H.innerHTML="";return}const r=n.map(s=>{const i=s.rating/5*100;return`
        ...
        </div>`}).join("");w.innerHTML=`<div class="recipes-list">${r}</div>`,ee(U,e),m?w.classList.add("category-selected"):w.classList.remove("category-selected")}catch(t){console.error("An error occurred while loading recipes:",t),w.innerHTML="<p>The recipes could not be loaded. Please try again later.</p>",H.innerHTML=""}}function ee(e,t){let n="";for(let s=1;s<=e;s++)n+=`<button class="pagination-btn ${s===t?"active":""}" data-page="${s}">${s}</button>`;H.innerHTML=n,H.querySelectorAll(".pagination-btn").forEach(s=>{s.addEventListener("click",()=>{const i=Number(s.dataset.page);i!==u&&(u=i,M(u))})})}window.addEventListener("resize",()=>{R()!==A&&(u=1,M(u))});y&&y.classList.add("active");P();M();const x=document.querySelector(".popular-recipe-wrapper");console.log(K());async function te(){try{x.innerHTML="<p>Loading recipes...</p>";const e=await K();if(!e||e.length===0){x.innerHTML="<p>No popular recipes found!</p>";return}const t=e.map(n=>`
  ...
  `,d.innerHTML=e<=1?"":i}function de(e){if(!a.recipes)return;if(!(e!=null&&e.length)){a.recipes.innerHTML="";return}const t=e.map(n=>{const{_id:r,title:s="Untitled",description:i="",rating:o=0,preview:g,thumb:p}=n,v=g||p||"",T=L(s),S=L(i),z=Number(o)||0,Y=Math.max(0,Math.min(100,z/5*100));return`
      <div class="recipe-card" data-id="${r||""}">
        ...
        ${v?`<img class="recipe-card-image" src="${v}" alt="${T}" loading="lazy">`:""}
      ...
      </div>`}).join("");a.recipes.innerHTML=t}async function k(){try{if(!oe()){ce();return}ae(),D(!0);const{time:e,area:t,ingredient:n,page:r,limit:s}=c,i=await se(_({time:e,area:t,ingredient:n,page:r,limit:s})),o=Array.isArray(i==null?void 0:i.results)?i.results:Array.isArray(i)?i:Array.isArray(i==null?void 0:i.recipes)?i.recipes:[],g=c.query.toLowerCase(),p=g?o.filter(v=>String(v.title||"").toLowerCase().includes(g)):o;if(j){if(de(p),d){const v=Number(i==null?void 0:i.totalPages)||Number(i==null?void 0:i.pageCount)||0,T=Number(i==null?void 0:i.total)||Number(i==null?void 0:i.count)||Number(i==null?void 0:i.resultsCount)||Number(i==null?void 0:i.hits)||(Array.isArray(i==null?void 0:i.results)?i.results.length:0),S=v||Math.max(1,Math.ceil((T||p.length)/(s||6)));le(S,c.page)}!p.length&&a.recipes&&(a.recipes.innerHTML='<p class="no-results">No recipes found</p>')}document.dispatchEvent(new CustomEvent("recipes:filtered",{detail:{recipes:p,paging:{page:r,limit:s},raw:i}}))}catch(e){console.error("[filters] applyFilters error:",(e==null?void 0:e.message)||e),j&&a.recipes&&(a.recipes.innerHTML=(e==null?void 0:e.message)==="REQUEST_TIMEOUT"?'<p class="no-results">İstek zaman aşımına uğradı. Lütfen tekrar deneyin.</p>':'<p class="no-results">Bir şeyler ters gitti. Lütfen tekrar deneyin.</p>'),document.dispatchEvent(new CustomEvent("recipes:filtered",{detail:{recipes:[],error:!0,reason:(e==null?void 0:e.message)||String(e)}}))}finally{D(!1)}}async function pe(){h("time",ne.map(e=>({value:re(e),label:e})));try{const e=await Z(),t=(Array.isArray(e)?e:[]).map(n=>typeof n=="string"?n:n==null?void 0:n.name).filter(Boolean).map(n=>({value:n,label:n}));h("area",t)}catch(e){console.error("Areas yüklenemedi",e),h("area",[])}try{const e=await X(),t=(Array.isArray(e)?e:[]).filter(n=>(n==null?void 0:n._id)&&(n==null?void 0:n.name)).map(n=>({value:n._id,label:n.name}));h("ingredient",t)}catch(e){console.error("Ingredients yüklenemedi",e),h("ingredient",[])}}function h(e,t){const n=a.dropdowns.find(i=>i.dataset.type===e);if(!n)return;const r=n.querySelector(".dropdown-menu"),s=n.querySelector(".dropdown-toggle");!r||!s||(r.innerHTML=(t||[]).map(i=>`<li><button type="button" data-value="${L(i.value)}" data-label="${L(i.label)}">${L(i.label)}</button></li>`).join(""),s.addEventListener("click",()=>{const i=!n.classList.contains("open");F(),n.classList.toggle("open",i)}),r.addEventListener("click",i=>{const o=i.target.closest("button[data-value]");if(!o)return;const g=o.getAttribute("data-value")??"",p=o.getAttribute("data-label")??o.textContent.trim();e==="time"?c.time=g:e==="area"?c.area=p:e==="ingredient"&&(c.ingredient=g,c.ingredientLabel=p),s.textContent=p,n.classList.remove("open"),c.page=1,k()}))}document.addEventListener("click",e=>{const t=e.target.closest(".custom-dropdown");if(!t)return F();a.dropdowns.forEach(n=>{n!==t&&n.classList.remove("open")})});document.addEventListener("keydown",e=>{e.key==="Escape"&&F()});function ue(){if(!a.search||!a.searchBtn)return;const e=()=>{c.query=a.search.value.trim(),c.page=1,k()};a.searchBtn.addEventListener("click",e),a.search.addEventListener("keydown",t=>{t.key==="Enter"&&(t.preventDefault(),e())})}function ge(){a.resetBtn&&a.resetBtn.addEventListener("click",()=>{c.query="",c.time="",c.area="",c.ingredient="",c.ingredientLabel="",c.page=1,a.search&&(a.search.value=""),k()})}(async function(){try{a.recipes&&(a.recipes.classList.add("recipes-list"),a.recipes.style.display="none"),d&&(d.style.display="none"),await pe(),ue(),ge(),await k(),d&&d.addEventListener("click",t=>{const n=t.target.closest(".pagination-btn");if(!n||n.classList.contains("dots"))return;const r=parseInt(n.dataset.page,10);!isNaN(r)&&r!==c.page&&(c.page=r,k())}),document.addEventListener("click",t=>{const n=t.target.closest(".heart-btn");n&&n.classList.toggle("active")}),document.addEventListener("click",t=>{const n=t.target.closest(".recipe-card-button");if(n){const r=n.closest(".recipe-card"),s=r==null?void 0:r.dataset.id;s&&console.log("Recipe clicked:",s)}})}catch(t){console.error("[filters] init error:",t),a.recipes&&(a.recipes.innerHTML='<p class="no-results">Bir şeyler ters gitti. Lütfen tekrar deneyin.</p>')}})();const Q="favoriteRecipes";function W(){try{return JSON.parse(localStorage.getItem(Q))||[]}catch{return[]}}function V(e){localStorage.setItem(Q,JSON.stringify(e))}function fe(e){const t=W();if(t.some(r=>r._id===e._id)){const r=t.filter(s=>s._id!==e._id);V(r)}else t.push(e),V(t)}function me(e){return W().some(n=>n._id===e)}const C=document.querySelector("#recipes-container"),N=document.querySelector("#pagination");let b=[],$=1,J=1,B=I();function ve(e,t=250){let n;return function(...r){clearTimeout(n),n=setTimeout(()=>{e.apply(this,r)},t)}}function I(){const e=window.innerWidth;return e<768?6:e<1280?8:9}async function O(e=1){try{B=I();const t=await _({page:e,limit:B});if(b=t.results,J=t.totalPages||Math.ceil(t.totalResults/B),!b||b.length===0){C.innerHTML="<p>No recipes found to display.</p>",N.innerHTML="";return}const n=b.map(r=>{const s=r.rating/5*100,i=me(r._id)?"active":"";return`
