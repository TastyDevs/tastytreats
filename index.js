/* empty css                      */(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function n(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(i){if(i.ep)return;i.ep=!0;const r=n(i);fetch(i.href,r)}})();const H="https://tasty-treats-backend.p.goit.global/api";async function K(){return await(await fetch(`${H}/categories`)).json()}async function N({category:e="",page:t=1,limit:n=6,time:s="",area:i="",ingredient:r=""}={}){const a=new URL(`${H}/recipes`);return e&&a.searchParams.append("category",e),t&&a.searchParams.append("page",t),n&&a.searchParams.append("limit",n),s&&a.searchParams.append("time",s),i&&a.searchParams.append("area",i),r&&a.searchParams.append("ingredient",r),await(await fetch(a)).json()}async function z(){return await(await fetch(`${H}/recipes/popular`)).json()}const h=document.querySelector("#recipes-container"),E=document.querySelector("#pagination"),M=document.querySelector("#category-list"),f=document.querySelector(".categories-box");let p=1,j=1,g=null,$=q();function q(){const e=window.innerWidth;return e<768?6:e<1280?8:9}async function Q(){try{const t=(await K()).map(s=>`
        ...
        </li>`).join("");M.innerHTML=t;const n=M.querySelectorAll(".category-btn");n.forEach(s=>{s.addEventListener("click",()=>{const i=s.dataset.category;i!==g&&(g=i,p=1,n.forEach(r=>r.classList.remove("active")),f.classList.remove("active"),s.classList.add("active"),w(p))})})}catch(e){console.error("Failed to load categories:",e)}}f&&f.addEventListener("click",()=>{g!==null&&(g=null,p=1,M.querySelectorAll(".category-btn").forEach(t=>t.classList.remove("active")),f.classList.add("active"),w(p))});async function w(e=1){try{$=q();const t=await N({page:e,limit:$,category:g||void 0}),n=t.results;if(j=t.totalPages||Math.ceil(t.totalResults/$),!n||n.length===0){h.innerHTML="<p>No recipes found to display.</p>",E.innerHTML="";return}const s=n.map(i=>{const r=i.rating/5*100;return`
        ...
        </div>`}).join("");h.innerHTML=`<div class="recipes-list">${s}</div>`,W(j,e),g?h.classList.add("category-selected"):h.classList.remove("category-selected")}catch(t){console.error("An error occurred while loading recipes:",t),h.innerHTML="<p>The recipes could not be loaded. Please try again later.</p>",E.innerHTML=""}}function W(e,t){let n="";for(let i=1;i<=e;i++)n+=`<button class="pagination-btn ${i===t?"active":""}" data-page="${i}">${i}</button>`;E.innerHTML=n,E.querySelectorAll(".pagination-btn").forEach(i=>{i.addEventListener("click",()=>{const r=Number(i.dataset.page);r!==p&&(p=r,w(p))})})}window.addEventListener("resize",()=>{q()!==$&&(p=1,w(p))});f&&f.classList.add("active");Q();w();const L=document.querySelector(".popular-recipe-wrapper");console.log(z());async function Y(){try{L.innerHTML="<p>Loading recipes...</p>";const e=await z();if(!e||e.length===0){L.innerHTML="<p>No popular recipes found!</p>";return}const t=e.map(n=>`
  ...
  `).join("");L.innerHTML=t}catch(e){console.error("Failed to fetch popular recipes:",e),L.innerHTML="<p>Sorry, we could not load the recipes at this time</p>"}}Y();let U,P,D;async function G(){const e=["./api/tastyTreatsApi.js"];for(const t of e)try{({fetchFilteredRecipes:U,fetchAreas:P,fetchIngredients:D}=await import(t)),console.log("[filters] API loaded from",t);return}catch{}throw new Error("API module not found. Check tastyTreatsApi.js path.")}const l=document.querySelector(".filters");l||console.warn("[filters] .filters bulunamadı.");const o={search:l==null?void 0:l.querySelector(".filter-input"),searchBtn:l==null?void 0:l.querySelector(".search-btn"),resetBtn:l==null?void 0:l.querySelector(".reset-filter"),dropdowns:[...(l==null?void 0:l.querySelectorAll(".custom-dropdown"))??[]],recipes:document.getElementById("recipes-flex")},C=!!o.recipes,c={query:"",time:"",area:"",ingredient:"",ingredientLabel:"",page:1,limit:6,loading:!1},X=["10 min","20 min","30 min","40 min"];function F(e){c.loading=e,!(!C||!o.recipes)&&e&&(o.recipes.innerHTML='<div class="recipes-loading">Loading...</div>')}function Z(e){const t=String(e).match(/\d+/);return t?t[0]:""}function x(e){o.dropdowns.forEach(t=>{t!==e&&t.classList.remove("open")})}async function ee(){v("time",X.map(e=>({value:Z(e),label:e})));try{const e=await P(),t=(Array.isArray(e)?e:[]).map(n=>typeof n=="string"?n:n==null?void 0:n.name).filter(Boolean).map(n=>({value:n,label:n}));v("area",t)}catch(e){console.error("Areas yüklenemedi",e),v("area",[])}try{const e=await D(),t=(Array.isArray(e)?e:[]).filter(n=>(n==null?void 0:n._id)&&(n==null?void 0:n.name)).map(n=>({value:n._id,label:n.name}));v("ingredient",t)}catch(e){console.error("Ingredients yüklenemedi",e),v("ingredient",[])}}function v(e,t){const n=o.dropdowns.find(r=>r.dataset.type===e);if(!n)return;const s=n.querySelector(".dropdown-menu"),i=n.querySelector(".dropdown-toggle");!s||!i||(s.innerHTML=(t||[]).map(r=>`<li><button type="button" data-value="${m(r.value)}" data-label="${m(r.label)}">${m(r.label)}</button></li>`).join(""),i.addEventListener("click",()=>{const r=!n.classList.contains("open");x(),n.classList.toggle("open",r)}),s.addEventListener("click",r=>{const a=r.target.closest("button[data-value]");if(!a)return;const u=a.getAttribute("data-value")??"",d=a.getAttribute("data-label")??a.textContent.trim();e==="time"?c.time=u:e==="area"?c.area=d:e==="ingredient"&&(c.ingredient=u,c.ingredientLabel=d),i.textContent=d,n.classList.remove("open"),c.page=1,A()}))}document.addEventListener("click",e=>{const t=e.target.closest(".custom-dropdown");if(!t)return x();o.dropdowns.forEach(n=>{n!==t&&n.classList.remove("open")})});document.addEventListener("keydown",e=>{e.key==="Escape"&&x()});function te(){if(!o.search||!o.searchBtn)return;const e=()=>{c.query=o.search.value.trim(),c.page=1,A()};o.searchBtn.addEventListener("click",e),o.search.addEventListener("keydown",t=>{t.key==="Enter"&&(t.preventDefault(),e())})}function ne(){o.resetBtn&&o.resetBtn.addEventListener("click",()=>{c.query="",c.time="",c.area="",c.ingredient="",c.ingredientLabel="",c.page=1,o.search&&(o.search.value=""),A()})}const ie=1e4,re=(e,t=ie)=>Promise.race([e,new Promise((n,s)=>setTimeout(()=>s(new Error("REQUEST_TIMEOUT")),t))]);async function A(){try{F(!0);const{time:e,area:t,ingredient:n,page:s,limit:i}=c,r=await re(U({time:e,area:t,ingredient:n,page:s,limit:i})),a=Array.isArray(r==null?void 0:r.results)?r.results:Array.isArray(r)?r:Array.isArray(r==null?void 0:r.recipes)?r.recipes:[],u=c.query.toLowerCase(),d=u?a.filter(b=>String(b.title||"").toLowerCase().includes(u)):a;C&&(se(d),!d.length&&o.recipes&&(o.recipes.innerHTML='<p class="no-results">No recipes found</p>')),document.dispatchEvent(new CustomEvent("recipes:filtered",{detail:{recipes:d,paging:{page:s,limit:i},raw:r}}))}catch(e){console.error("[filters] applyFilters error:",(e==null?void 0:e.message)||e),C&&o.recipes&&(o.recipes.innerHTML=(e==null?void 0:e.message)==="REQUEST_TIMEOUT"?'<p class="no-results">İstek zaman aşımına uğradı. Lütfen tekrar deneyin.</p>':'<p class="no-results">Bir şeyler ters gitti. Lütfen tekrar deneyin.</p>'),document.dispatchEvent(new CustomEvent("recipes:filtered",{detail:{recipes:[],error:!0,reason:(e==null?void 0:e.message)||String(e)}}))}finally{F(!1)}}function se(e){if(!o.recipes)return;if(!(e!=null&&e.length)){o.recipes.innerHTML="";return}const t=e.map(n=>{const{_id:s,title:i="Untitled",time:r="",rating:a="",preview:u,thumb:d,description:b=""}=n,R=u||d||"";return`
      <article class="recipe-card" data-id="${s||""}">
        ...
        </div>`}).join("");T.innerHTML=s,le(I,e)}catch(t){console.error("An error occurred while loading recipes:",t),T.innerHTML="<p>The recipes could not be loaded. Please try again later.</p>",S.innerHTML=""}}S.addEventListener("click",e=>{const t=e.target.closest(".pagination-btn");if(!t||t.disabled||!t.dataset.page)return;const n=Number(t.dataset.page);n!==y&&(y=n,_(y))});T.addEventListener("click",e=>{const t=e.target.closest(".heart-btn");if(!t)return;const s=t.closest(".recipe-card").dataset.id;ae({_id:s}),t.classList.toggle("active")});function le(e,t){let n="";const i="pagination-btn arrow-btn arrow-prev",r="pagination-btn arrow-btn arrow-next";if(n+=`<button class="${i}" data-page="1" ${t===1?"disabled":""}>
  ...
  </button>`,S.innerHTML=n}const de=ce(()=>{const e=B();e!==k&&(console.log(`Resize detected. New limit: ${e}. Refetching...`),y=1,_(y))});window.addEventListener("resize",de);_();
